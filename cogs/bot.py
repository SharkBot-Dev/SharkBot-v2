...
class BotCog(commands.Cog):
    ...
    async def about_bot(self, interaction: discord.Interaction):
        ...
        view.add_item(discord.ui.Button(
            label="招待リンク", url="https://discord.com/oauth2/authorize?client_id=1322100616369147924&permissions=1759218604441591&integration_type=0&scope=bot+applications.commands"))
        ...
        em.add_field(name="サーバー数", value=f"{len(self.bot.guilds)}サーバー").add_field(
            name="ユーザー数", value=f"{len(self.bot.users)}人")
    ...
    async def invite_bot(self, interaction: discord.Interaction, botのid: discord.User):
        ...
        mem_kengen = discord.utils.oauth_url(
            botのid.id, permissions=gu.permissions)
