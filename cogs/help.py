...
HELP_TREE = {
    "管理機能": {
        "モデレーション": [
            ...
            {
                "name": "moderation ban unban",
                "description": "ユーザーのBanを解除します。",
            },
            {
                "name": "moderation ban massban",
                "description": "複数人を一斉にbanします。",
            },
            {
                "name": "moderation ban softban",
                "description": "Ban機能を利用してメッセージを一斉削除します。",
            },
            {
            ...
            {
                "name": "moderation untimeout",
                "description": "タイムアウトを解除します。",
            },
            {
                "name": "moderation max-timeout",
                "description": "タイムアウトができる最大までタイムアウトします。",
            },
            {"name": "moderation clear", "description": "メッセージを削除します。"},
            {"name": "moderation warn", "description": "メンバーを警告します。"},
            {
                "name": "moderation warns",
                "description": "メンバーの警告回数を確認します。",
            },
            ...
            {"name": "moderation unlock", "description": "チャンネルを開放します。"},
            {
                ...
                "description": "通報チャンネルをセットアップします。",
            },
            {
                "name": "moderation serverban",
                "description": "web認証時に指定したサーバーに入っていると認証できなくします。",
            },
            {
                "name": "moderation serverunban",
                "description": "web認証時に指定したサーバーに入っていても認証できるようにします。",
            },
        ...
        "DM・招待停止": [
            {
                "name": "moderation pause invite",
                "description": "招待を一時停止します。",
            },
            {"name": "moderation pause dm", "description": "DMを一時停止します。"},
            {
                "name": "moderation pause both",
                "description": "DMと招待を一時停止します。",
            },
        ],
        "自動管理": [
            ...
            {
                "name": "automod customword",
                "description": "カスタムワードを禁止するAutoModを作成します。",
            },
        ],
        "自動返信": [
            ...
            {
                "name": "autoreply templates",
                "description": "自動返信をテンプレートから作成します。",
            },
            {
                "name": "autoreply export",
                "description": "自動返信ををエクスポートします。",
            },
            {
                "name": "autoreply import",
                "description": "自動返信ををインポートします。",
            },
        ],
        "自動リアクション": [
            {
                "name": "autoreact channel",
                "description": "自動リアクションをチャンネルを条件にして作成します。",
            },
            {
                "name": "autoreact word",
                "description": "自動リアクションをワードを条件にして作成します。",
            },
            {
                "name": "autoreact remove",
                "description": "自動リアクションを削除します。",
            },
            {
                "name": "autoreact list",
                "description": "自動リアクションをリスト化します。",
            },
        ],
        "自動GIF・GIF検索": [
            {"name": "gif search", "description": "GIFを検索します。"},
            {
                "name": "gif autogif-channel add",
                "description": "自動gif返信のチャンネルを追加します。",
            },
            {
                "name": "gif autogif-channel remove",
                "description": "自動gif返信チャンネルを削除します。",
            },
        ],
        "オフライン検知": [
            {
                "name": "autodown settings",
                "description": "オフライン検知の設定を確認します。",
            },
            {
                "name": "autodown vc-kick",
        ...
        "ロール管理": [
            ...
            {
                "name": "role can-bot",
                "description": "そのロールをBotが扱えるかをチェックします。",
            },
        ],
        "ニックネーム管理": [
        ...
        "VC管理": [
            ...
            {
                "name": "vc temp",
                "description": "一時的なVCを作成できるチャンネルを作成します。",
            },
        ...
        "様々なパネル": {
            "ロールパネル": [
                ...
                {
                    "name": "panel role-edit",
                    "description": "ロールパネルを編集します。",
                },
                {
                    "name": "panel newgui-rolepanel",
                    "description": "新しいロールパネルを作成します。",
                },
                {
                    "name": "panel newgui-rolepanel-edit",
                    "description": "新しいロールパネルを編集します。",
                },
                {
                    "name": "panel select-rolepanel",
                    "description": "セレクトボックス式ロールパネルを作成します。",
                },
                {
                    "name": "panel random",
                    "description": "ランダムなロールが付与されるロールパネルを作成します。",
                },
            ],
            "アンケート・メンバー募集": [
            ...
            "認証": [
                {
                    "name": "panel auth abs-auth",
                    "description": "絶対値を入力させる認証パネルを作成します。",
                },
                {
                    "name": "panel auth arror-auth",
                    "description": "矢印の向きを入力させるパネルを作成します。",
                },
                {
                    "name": "panel auth auth",
                    "description": "ワンクリック認証パネルを作成します。",
                },
                {
                    "name": "panel auth-plus",
                    "description": "認証したらロールが外れた後にロールが付くパネルを作ります。",
                },
                {
                    "name": "panel auth webauth",
                    "description": "Web認証パネルを作成します。",
                },
                {
                    "name": "panel auth image",
                    "description": "画像認証パネルを作成します。",
                },
                {
                    "name": "panel auth guideline",
                    "description": "ルールに同意させるパネルを作成します。",
                },
                {
                    "name": "panel auth auth-reqrole",
                    "description": "認証パネルに必要なロールを設定します。",
                },
            ],
        },
        "グローバルチャット": [
            ...
            {
                "name": "global sgc",
                "description": "スーパーグローバルチャットに参加します。",
            },
            {
                "name": "global sgc-info",
                "description": "スーパーグローバルチャットの情報を取得します。",
            },
        ],
        "レベル・実績": {
            "レベル": [
                ...
                {
                    "name": "level card-custom",
                    "description": "レベルカードをカスタマイズします。",
                },
                {"name": "level card", "description": "レベルカードを作成します。"},
                {
                    "name": "level channel",
                    "description": "レベルアップ通知を設定します。",
                },
                {
                    "name": "level role",
                    "description": "レベルアップ時の付与するロールを設定します。",
                },
                {
                    "name": "level message",
                    "description": "レベルアップ時に送信するメッセージを修正します。",
                },
                {"name": "level edit", "description": "レベルを編集します。"},
                {
                    "name": "level timing",
                    "description": "レベルアップするタイミングを設定します。",
                },
                {
                    "name": "level rewards",
                    "description": "レベルアップ時の報酬を取得します。",
                },
                {
                    "name": "level ranking",
                    "description": "レベルランキングを取得します。",
                },
            ...
            "実績": [
                {"name": "achievement setting", "description": "実績を有効化します。"},
                {
                    ...
                    "description": "達成した・達成可能な実績一覧を表示します。",
                },
                {"name": "achievement create", "description": "実績を作成します。"},
                {"name": "achievement delete", "description": "実績を削除します。"},
                {
                    "name": "achievement channel",
                    "description": "実績の通知をするチャンネルをセットアップします。",
                },
        ...
        "Give a way": [
            {
                ...
                "description": "サーバー内でのプレゼント企画を実施します。",
            }
        ],
        "サーバー掲示板": [
            ...
            {
                "name": "global server",
                "description": "サーバー掲示板のURLを取得します。",
            },
            {"name": "global up", "description": "サーバー掲示板でUPをします。"},
        ],
        "サーバーステータス": [
            {
                "name": "server-status create",
                "description": "サーバーのステータスをチャンネルに表示します。",
            },
            {
                "name": "server-status disable",
                "description": "サーバーステータスをすべて無効化します。",
            },
        ],
        "ログ": [
            ...
            {
                "name": "logging ignore",
                "description": "ログを無視するチャンネルを設定します。",
            },
        ],
        "様々なアラート": [
            {
                "name": "alert news",
                "description": "ニュースを通知するチャンネルをセットアップします。",
            },
            {
                "name": "alert event",
                "description": "イベント作成を通知するチャンネルをセットアップします。",
            },
            {
                "name": "alert mention",
                "description": "通知時に一緒に送るメンションを指定します。",
            },
        ],
        "その他設定": [
            {
                "name": "settings lock-message",
                "description": "固定メッセージをセットアップします。",
            },
            {"name": "settings prefix", "description": "頭文字を設定します。"},
            {"name": "settings score", "description": "処罰スコアを設定します。"},
            {
                "name": "settings warn-setting",
                "description": "AutoModでの警告時に実行する内容を設定します。",
            },
            {
                "name": "settings expand",
                "description": "メッセージ展開をセットアップします。",
            },
            {
                "name": "settings auto-publish",
                "description": "自動アナウンス公開をセットアップします。",
            },
            {
                "name": "settings file-deletor",
                "description": "自動的に削除するファイル拡張子を設定します。",
            },
            {
                "name": "settings auto-translate",
                "description": "自動翻訳を設定します。",
            },
            {
                "name": "settings good-morning",
                "description": "Botが挨拶をするチャンネルをセットアップします。",
            },
            {
                "name": "settings auto-thread",
                "description": "自動スレッド作成をセットアップします。",
            },
            {
                "name": "settings lang",
                "description": "Change the bot's language. (Beta)",
            },
        ],
    },
    "便利機能": {
        "ネットワークツール": [
            ...
            {
                "name": "tools network meta",
                "description": "サイトのメタデータを取得します。",
            },
            {
                "name": "tools network ping",
                "description": "ドメインにPingを送信します。",
            },
        ...
        "計算機能": [
            {
                "name": "tools calc size-converter",
                "description": "サイズの計算をします。",
            },
    ...
    "検索機能": {
        "Discord上の検索": [
            ...
            {
                "name": "search tag",
                "description": "サーバータグを何人がつけているかを検索します。",
            },
        ...
        "Web上の検索": [
            ...
            {
                "name": "search web safeweb",
                "description": "SafeWebでURLの安全性をチェックします。",
            },
    ...
    "面白い機能": {
        "グローバルゲーム": [
            {
                "name": "game emerald mining",
                "description": "ゲームをするのに必要なエメラルドを集めます。",
            },
            {"name": "game emerald slot", "description": "スロットを回します。"},
            {"name": "game emerald info", "description": "自分の情報を取得します。"},
            {
                "name": "game emerald buy",
                "description": "エメラルドを使ってアイテムを購入します。",
            },
        ],
        "グローバルな木": [
            ...
            {
                "name": "tree status",
                "description": "グローバルな木の情報を取得します。",
            },
            {
                "name": "tree mystatus",
                "description": "自分の育てた木の情報を取得します。",
            },
        ],
        "ペット育成": [
        ...
        "スクラッチ": [
            {
                "name": "game scratch user",
                "description": "スクラッチでのユーザーを取得します。",
            },
            {
                "name": "game scratch project",
                "description": "スクラッチのプロジェクトを取得します。",
            },
        ],
        "Osu": [
        ...
        "フォートナイト": [
            {
                "name": "game fortnite map",
                "description": "フォートナイトのマップを取得するよ",
            },
            {
                "name": "game fortnite player",
                "description": "フォートナイトのプレイヤーを取得します。",
            },
        ],
        "Minecraft": [
            {
                "name": "game minecraft player",
                "description": "Minecraftのプレイヤーの情報を取得するよ",
            },
            {
                "name": "game minecraft java-server",
                "description": "Javaのサーバーを取得します。",
            },
            {
                "name": "game minecraft seedmap",
                "description": "シード値から構造物などを検索します。",
            },
        ],
        "ミニゲーム": [
        ...
        "誕生日設定": [
            ...
            {
                "name": "fun birthday get",
                "description": "ほかの人の誕生日を取得します。",
            },
            {
                "name": "fun birthday list",
                "description": "今月が誕生日の人を表示します。",
            },
        ],
        "発言": [
        ...
        "音声・読み上げ": {
            ...
            "読み上げ": [
                ...
                {
                    "name": "tts dict remove",
                    "description": "読み上げ辞書を削除します。",
                },
                {
                    "name": "tts dict list",
                    "description": "読み上げ辞書をリスト化します。",
                },
                ...
                {
                    "name": "tts info",
                    "description": "読み上げしているサーバー数を取得します。",
                },
        ...
        "動画作成": [
            {
                "name": "fun movie sea",
                "description": "海の背景の動画に画像を組み合わせます。",
            }
        ],
        "テキスト・画像作成": {
            "テキスト": [
                {
                    "name": "fun text suddendeath",
                    "description": "突然の死を作成します。",
                },
                {"name": "fun text retranslate", "description": "再翻訳します。"},
                {
                    "name": "fun text text-to-emoji",
                    "description": "テキストを絵文字にします。",
                },
                ...
                {
                    "name": "fun text arm",
                    "description": "armのasmを、バイナリに変換します。",
                },
                {"name": "fun text morse", "description": "モールス信号に変換します。"},
            ],
            "脳内メーカー": [
                {
                    "name": "fun nounai nounai",
                    "description": "脳内メーカーを使用します。",
                },
                {"name": "fun nounai kakeizu", "description": "家系図を作成します。"},
                {
                    "name": "fun nounai busyo",
                    "description": "武将メーカーを使用します。",
                },
                {"name": "fun nounai kabuto", "description": "兜を作成します。"},
                {
                    "name": "fun nounai tenshoku",
                    "description": "転職メーカーを使用します。",
                },
            ],
            "動物画像": [
                ...
                {
                    "name": "fun animal duck",
                    "description": "アヒルの画像を作成します。",
                },
            ],
            "画像作成": [
                {"name": "fun image 5000", "description": "5000兆円ほしい！"},
                {
                    "name": "fun image emoji-kitchen",
                    "description": "絵文字キッチンを使用します。",
                },
                {
                    "name": "fun image textmoji",
                    "description": "テキストを文字にします。",
                },
                {"name": "fun image httpcat", "description": "HTTPCatを使用します。"},
                {
                    "name": "fun image miq",
                    "description": "Make it a quoteを作成します。",
                },
                {
                    "name": "fun image ascii",
                    "description": "アスキーアートを作成します。",
                },
                {"name": "fun image imgur", "description": "Imgurで検索します。"},
                {
                    "name": "fun image game",
                    "description": "ゲームのコラ画像を作成します。",
                },
                {
                    "name": "fun image profile",
                    "description": "プロフィールを作成します。",
                },
            ],
            "キャラクター・ランキング": {
                "キャラクター": [
        ...
        "サーバー内経済": {
            "基本": [
                ...
                {
                    "name": "economy crime",
                    "description": "犯罪をしてお金を得ます。(リスクあり)",
                },
                {
                    "name": "economy balance",
                    "description": "サーバー内で残高を取得します。",
                },
                {
                    "name": "economy pay",
                ...
                {
                    "name": "economy game coinflip",
                    "description": "コインの表裏を予想します。",
                },
                {
                    "name": "economy game blackjack",
                    "description": "ブラックジャックをします。",
                },
                {
                    "name": "economy game info",
                    "description": "ゲームの情報を取得します。",
                },
            ],
            "ガチャ": [
                {"name": "economy gacha create", "description": "ガチャを作成します。"},
                {
                    "name": "economy gacha import",
                    "description": "Jsonからガチャをインポートします。",
                },
                {
                    "name": "economy gacha export",
                    "description": "Jsonにガチャをエクスポートします。",
                },
                {
                    "name": "economy gacha add",
                    "description": "ガチャにアイテムを追加します。",
                },
                {
                    "name": "economy gacha multi-add",
                    "description": "確率操作をするために、一つのアイテムを複数追加します。",
                },
                {
                    "name": "economy gacha remove",
                    "description": "ガチャのアイテムを削除します。",
                },
                {
                    "name": "economy gacha clear",
                    "description": "ガチャのアイテムをリセットします。",
                },
                {
                    "name": "economy gacha items",
                    "description": "ガチャから出るアイテムを確認します。",
                },
                {
                    "name": "economy gacha list",
                    "description": "ガチャリストを確認します。",
                },
            ...
            "管理": [
                ...
                {
                    "name": "economy manage currency",
                    "description": "新しい通貨名を設定します。",
                },
                {
                    "name": "economy manage chatmoney",
                    "description": "会話するたびにお金がもらえるようにします。",
                },
                {
                    "name": "economy item create",
                    "description": "アイテムを作成します。",
                },
                {
                    "name": "economy item remove",
                    "description": "アイテムを削除します。",
                },
                {
                    "name": "economy shop item",
                    "description": "アイテムショップパネルを作成します。",
                },
            ],
        },
    },
    "Bot関連の機能": {
        ...
        "Botのカスタマイズ": [
            {
                "name": "bot custom",
                "description": "Botのアバターなどをカスタマイズします。",
            }
        ],
    },
}
...
class CategorySelect(discord.ui.Select):
    def __init__(self, tree: dict, path: list):
        ...
        options = [discord.SelectOption(label=str(key)) for key in tree.keys()]

        super().__init__(
            placeholder=" > ".join(path) + " のカテゴリを選択", options=options
        )
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if isinstance(next_tree, dict):
            ...
            embed = make_embed.success_embed(title="ヘルプ : " + " > ".join(new_path))
            ...
            await interaction.response.edit_message(
                embed=embed, view=BackOnlyView(self.path), content=""
            )
...
class HelpCog(commands.Cog):
    ...
    async def help(
        ...
        ヘルプの表示形態: app_commands.Choice[str] = None,
    ):
        await interaction.response.defer()

        if ヘルプの表示形態 == app_commands.Choice(
            name="見やすくなったヘルプ", value="new"
        ):
            embeds = []
            ...
            return
        elif ヘルプの表示形態 == app_commands.Choice(
            name="カテゴリ別のヘルプ", value="category"
        ):
            pages = []
            ...
            pages.append(
                discord.Embed(
                    title="カテゴリ別のヘルプ",
                    description="▶️ ボタンでメインのヘルプを閲覧できます。",
                    color=discord.Color.blue(),
                ).add_field(
                    name="このヘルプについて",
                    value="スラッシュコマンド版のヘルプです。\n頭文字コマンド用ヘルプは !.help を使用してください。",
                    inline=False,
                )
            )
            ...
            for c in self.bot.tree.get_commands():
                if type(c) == app_commands.Command:
                    ...
                    embed = discord.Embed(
                        title=f"/{c.name} ({c.description})", color=discord.Color.blue()
                    )
                    text = ""
                    for cc in c.commands:
