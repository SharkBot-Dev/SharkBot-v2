        ...
        async def wrapper():
            try:
                if not await command_disable.command_enabled_check(interaction):
                    ...
                    last_message_time = cooldown_check.get(
                ...
                if not await channel_command_disable.disable_channel(interaction):
                    ...
                    return await interaction.response.send_message(ephemeral=True, content="このチャンネルではコマンドを使用できません。")
                ...
                if not await bot_ban.ban_user_block(interaction):
                    ...
                    return await interaction.response.send_message(ephemeral=True, content="あなた、もしくはサーバーがBotからBanされています。")
