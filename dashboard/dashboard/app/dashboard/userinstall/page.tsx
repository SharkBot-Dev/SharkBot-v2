...
export default async function UserInstall() {
    async function createNewApp(formData: FormData) {
        ...
        redirect("/dashboard/userinstall");
    }
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div>
        <h2 className="text-xl font-semibold mb-2">登録済みアプリ</h2>
        ...
        {apps.length === 0 ? (
          ...
          <ul className="space-y-2">
            {apps.map((app) => (
              ...
              >
                <a href={`/dashboard/userinstall/${app.AppID}`}><div>
